...
![image](https://github.com/ivanjrt/PiHole-Backup-Ubuntu/assets/44326428/b417d823-2cf1-4099-8bb0-e90aeca25b3f) <br/>
 where pihole is the user name with admin rights. This process will omit the password input every time he puts sudo in the beginning. <br/>
...
it will ask you for the IP of the secondary PiHole and the username, and at the end it will run its first sync and will show the result<br/>
the password that it will ask is the password for the remote host's  <br/>
 ...
 * `gravity-sync` both
 * ![image](https://user-images.githubusercontent.com/44326428/218904300-9557ef44-438a-4f55-aa59-a2f07c2d84b1.png) <br/>
...
![image](https://github.com/ivanjrt/PiHole-Backup-Ubuntu/assets/44326428/0032fd67-7189-46ca-abd9-ff69150d72d7) <br/>
