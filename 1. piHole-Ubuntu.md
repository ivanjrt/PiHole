...
* To change password (preferred to do this when the machine reboots)
```
pihole setpassword
```
- Test the website and if success then shutdown the VM, Reserve the IP in the DHCP and then save it  <br/>
...
location paths:
```
http://10.10.10.2/admin/settings/dns
or
http://10.10.10.8/admin/settings.php?tab=dns
```
![image](https://github.com/user-attachments/assets/322420d5-dc7e-4f42-820f-e66e2e3f971b)
